    ...
    app.use(async (ctx, next) => {
        ...
        if (ctx.response.is('js') &&
            ...
            if (rewriteCache.has(content)) {
                ...
                await es_module_lexer_1.init;
                ctx.body = rewriteImports(content, ctx.url.replace(/(&|\?)t=\d+/, ''), resolver, ctx.query.t);
        ...
        if (imports.length) {
            ...
            imports.forEach(({ s: start, e: end, d: dynamicIndex }) => {
                ...
                if (dynamicIndex === -1) {
                    ...
                    const importee = slash_1.default(path_1.default.resolve(path_1.default.dirname(importer), resolved));
